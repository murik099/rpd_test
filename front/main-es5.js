(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CommentFormComponent = /** @class */ (function () {
                function CommentFormComponent(formBuilder, api) {
                ...
                CommentFormComponent.prototype.controlIsInvalid = function (name) {
                    return this.commentForm.controls[name].invalid &&
                        (this.commentForm.controls[name].dirty || this.commentForm.controls[name].touched);
                };
                CommentFormComponent.prototype.markControlsAsTouched = function (form) {
                ...
                CommentFormComponent.prototype.invalidText = function (name) {
                    var field = this.commentForm.controls[name];
                    if (field.errors) {
                ...
                CommentFormComponent.prototype.submit = function () {
                    ...
                    this.api.sendComment(comment).subscribe(function (data) {
                        if (data) {
                            _this.commentForm.reset();
                            _this.formError = false;
                        }
                    }, function (error) {
                        _this.formError = error.statusText;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CommentComponent = /** @class */ (function () {
                function CommentComponent(activatedRoute, api) {
                ...
                CommentComponent.prototype.ngOnInit = function () {
                    ...
                    this.api.getComment(key).subscribe(function (data) {
                        _this.comment = data.result;
                        _this.isLoading = false;
                    }, function (error) {
                        _this.isError = error.statusText;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CommentsListComponent = /** @class */ (function () {
                ...
                CommentsListComponent.prototype.ngOnInit = function () {
                    this.comments = this.api.comments.sort(function (a, b) {
                        var x = new Date(a.date_time);
                        var y = new Date(b.date_time);
                        return +x - +y;
                    });
                };
                CommentsListComponent.prototype.getHref = function (id) {
                    return "/comment/" + id;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LayoutComponent = /** @class */ (function () {
                function LayoutComponent(api) {
                    this.api = api;
                }
                LayoutComponent.prototype.ngOnInit = function () { };
                LayoutComponent.prototype.getColor = function (id) {
                    var hash = 0;
                    for (var i = 0; i < id.length; i++) {
                        var n = id.charCodeAt(i);
                        hash += n;
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApiService = /** @class */ (function () {
                ...
                ApiService.prototype.updateServerInfo = function (info) {
                    this.hostName = info.host_name;
                    this.comments = info.result;
                    this.comments$.next(this.comments);
                };
                ApiService.prototype.fetchServerInfo = function () {
                    var _this = this;
                    this.isLoading = true;
                    return this.http.get("http://" + location.hostname + ":80/notes").subscribe(function (data) {
                        _this.updateServerInfo(data);
                        _this.isLoading = false;
                    }, function (error) {
                        _this.isError = error.statusText;
                    });
                };
                ApiService.prototype.getComment = function (id) {
                    return this.http.get("http://" + location.hostname + ":80/note/" + id);
                };
                ApiService.prototype.sendComment = function (comment) {
                    var _this = this;
                    var httpOptions = {
                    ...
                    return this.http
                        ...
                        var comments = _this.comments.slice(0);
                        comments.push(res.result);
                        _this.comments = comments;
                        _this.comments$.next(comments);
                    }));
                };
                return ApiService;
            }());
